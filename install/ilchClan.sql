...
('title', 'input', NULL, 'Allgemein', 'Titel der Seite', 'Das Clanscript f&uuml;r jeden!', 0, 0, NULL),
...
('allg_menupoint_access', 'r2', NULL, 'Allgemein', 'Zugriff auf nicht im Men&uuml; verlinkte Module f&uuml;r alle?', '0', 0, 0, NULL),
...
('show_session_id', 'r2', NULL, 'Allgemein', 'SessionID bei G&auml;sten anzeigen?', '1', 0, 0, NULL),
...
('mail_smtp', 'r2', NULL, 'Allgemein', 'SMTP f&uuml;r den Mailversand verwenden? <a href="admin.php?smtpconf" class="smalfont">weitere Einstellungen</a>', '0', 0, 0, NULL),
...
('menu_anz', 'input', NULL, 'Allgemein', 'Wie viele Men&uuml;s sollen verwaltet werden?', '5', 0, 0, NULL),
...
('inactive', 'r2', NULL, 'Allgemein', 'Ab wie vielen Wochen z&auml;hlt ein User als inaktiv ?', '12', 0, 1, NULL),
