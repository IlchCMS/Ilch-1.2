...
('jqueryui', 's', NULL, 'Allgemeine', 'jQueryUI Theme', 'redmond', 0, 0, NULL),
('gbook_posts_per_site', 'input', NULL, 'G&auml;stebuch', 'Eintr&auml;ge pro Seite', '20', 0, 0, NULL),
...
('gfx', 's', NULL, 'Allgemeine', 'Standard Design', 'ilchClan', 0, 0, NULL),
('smodul', 's', NULL, 'Allgemeine', 'Start Modul der Seite', 'news', 0, 0, NULL),
('title', 'input', NULL, 'Allgemeine', 'Titel der Seite', 'Das Clanscript f&uuml;r jeden!', 0, 0, NULL),
('Fabreite', 'input', NULL, 'Forum', 'max Breite f&uuml;r den Avatar', '80', 0, 0, NULL),
('Fahohe', 'input', NULL, 'Forum', 'max H&ouml;he f&uuml;r den Avatar', '80', 0, 0, NULL),
('Gsperre', 'input', NULL, 'G&auml;stebuch', 'Ip Sperre in Sekunden', '3600', 0, 0, NULL),
('Gtxtl', 'input', NULL, 'G&auml;stebuch', 'max Text l&auml;nge im G&auml;stebuch', '600', 0, 0, NULL),
('Aart', 'r2', NULL, 'Archiv', 'Soll die Partner Box sortiert werden', '0', 0, 0, NULL),
('Ngkoms', 'r2', NULL, 'News', 'D&uuml;rfen G&auml;ste Kommentare schreiben?', '1', 0, 0, NULL),
('Nukoms', 'r2', NULL, 'News', 'D&uuml;rfen User Kommentare schreiben?', '1', 0, 0, NULL),
('allg_menupoint_access', 'r2', NULL, 'Allgemeine', 'Zugriff auf nicht im Men&uuml; verlinkte Module f&uuml;r alle?', '0', 0, 0, NULL),
('forum_regist', 'r2', NULL, 'Forum', 'D&uuml;rfen sich User registrieren?', '1', 0, 0, NULL),
('forum_regist_user_pass', 'r2', NULL, 'Forum', 'Passwort vom User beim registrieren selber w&auml;hlbar?', '1', 0, 0, NULL),
('forum_regist_confirm_link', 'r2', NULL, 'Forum', 'Registrierung per Link im eMail best&auml;tigen?', '1', 0, 0, NULL),
('archiv_down_userupload', 'r2', NULL, 'Archiv', 'D&uuml;rfen User Dateien hochladen?', '1', 0, 0, NULL),
('show_session_id', 'r2', NULL, 'Allgemeine', 'SessionID bei G&auml;sten anzeigen?', '1', 0, 0, NULL),
('wars_last_komms', 's', NULL, 'Wars', 'Kommentare f&uuml;r Lastwars', '0', 0, 0, NULL),
...
('allg_bbcode_max_img_width', 'input', NULL, 'Allgemeine', 'Wie Breit solle ein Bild maximal sein (in Pixeln)?', '230', 0, 0, NULL),
('forum_default_avatar', 'r2', NULL, 'Forum', 'Standard Avatar anzeigen?', '1', 0, 0, NULL),
('allg_default_subject', 'input', NULL, 'Allgemeine', 'Standard Absender bei eMails', 'automatische eMail', 0, 0, NULL),
('sb_maxwordlength', 'input', NULL, 'Shoutbox', 'Maximale Wortl&auml;nge in der Shoutbox', '10', 0, 0, NULL),
...
('antispam', 'grecht2', NULL, 'Allgemeine', 'Antispam <small>(ab diesem Recht keine Eingabe mehr erforderlich)</small>', '-2', 0, 0, NULL),
('joinus_rules', 'r2', NULL, 'Team', 'Regeln bei Joinus vollst&auml;ndig anzeigen?', '0', 0, 0, NULL),
('groups_forall', 'r2', NULL, 'Team', 'Modulrecht <i>Gruppen</i> auf eigene Gruppe beschr&auml;nken?', '1', 0, 0, NULL),
('lang', 's', NULL, 'Allgemeine', 'Standard Sprache', 'de', 0, 0, NULL),
('mail_smtp', 'r2', NULL, 'Allgemeine', 'SMTP f&uuml;r den Mailversand verwenden? <a href="admin.php?smtpconf" class="smalfont">weitere Einstellungen</a>', '0', 0, 0, NULL),
('userpic_Fabreite', 'input', NULL, 'Forum', 'max Breite f&uuml;r das Userpic', '160', 0, 0, NULL),
('userpic_Fahohe', 'input', NULL, 'Forum', 'max H&ouml;he f&uuml;r das Userpic', '160', 0, 0, NULL),
...
('menu_anz', 'input', NULL, 'Allgemeine', 'Wie viele Men&uuml;s sollen verwaltet werden?', '5', 0, 0, NULL),
('revision', 'input', NULL, 'Allgemeine', 'Revisionsnummer', '240', 0, 0, NULL),
('threadersteller_in_uebersicht', 'r2', NULL, 'Forum', 'Threadersteller - Anzeige in &uuml;bersicht?', '0', 0, 0, NULL),
('show_tooltip', 'r2', NULL, 'Kalender', 'Event-Tooltips', '1', 0, 0, 'Wenn aktiviert werden bei Kalendereintr&auml;gen in einem Tooltip schon Details zu dem Eintrag angezeigt.'),
('modrewrite', 'radio', NULL, 'Allgemeine', 'ModReWrite an / aus', '0', 0, 1, NULL),
('wartung', 'r2', NULL, 'Allgemeine', 'Wartungsmodus ?', '0', 0, 0, NULL),
('wartungstext', 'input', NULL, 'Allgemeine', 'Wartungstext', '0', 0, 0, NULL),
('inactive', 'r2', NULL, 'Allgemeine', 'Ab wie vielen Wochen z&auml;hlt ein User als inaktiv ?', '12', 0, 1, NULL),
