-- Dies ist ein Testprofil. Bitte nicht öffentlich verwenden. Author annemarie DeLuXe and raub-copied von GeCk0. Und wann kommt das "richtige" Portfolio ? :) Achja und hier geht kein html und kein BB-Code und es muss mit dem SQL-Kommentar angeführt in der ersten Zeile stehen. ;)
...
-- Wollt ihr ein SQL-Dump von Euch veröffentlichen sollten einige Informationen in den folgenden Kommentarzeilen angegeben werden.

-- WICHTIG !!!
-- alle prefixes wie "ic1_" durch "prefix_" ersetzen !!!
-- Dumps sollten ohne Autoincrement sein.

-- Ilch.de übernimmt keine Haftung/Support für fremde installations-Dateien/Dumps und deren Folgen.

-- Dumped by GeCk0
-- Website: http://gecko-dev.de
