...
if ($menu->get(1) == 'gotoDate') {
    $yearToView = $menu->get(2);
    $monthToView = $menu->get(3) - 1;
    $dayToView = $menu->get(4);
	  $view = "defaultView: 'basicDay',";
    $viewDate = "calendar.fullCalendar('gotoDate',".$yearToView.",".$monthToView.",".$dayToView.")";
} else {
    $view = "";
    $viewDate = "";
}

$tpl->set('defaultView', $view);
$tpl->set('kalenderevents', json_encode($json_encode));
$tpl->set('gotoDate', $viewDate);
$tpl->out();
$design->footer();
?>