...
$tpl->set_ar_out($tpl_ar, 1);
	...
	# Nun muß ermittelt werden was nun der letzte Post im neuen Topic ist
	...
	while($row = db_fetch_assoc($erg))
	{
		if ( $row['time'] > $newest_post_in_tid['time'] ) {  # Wenn eingelesener Post neuer als vorher ausgewerteter Post
  ...
  # Nun muß ermittelt werden was nun der letzte Post im alten Topic ist
