...
if (!loggedin()) {
    echo 'G&auml;ste d&uuml;rfen keine Beitr&auml;ge editieren<br><a href="index.php?user-regist">Registrieren</a> / <a href="index.php?user-login">Einloggen</a> um deine Beitr&auml;ge editieren zu k&ouml;nnen';
    $design->footer(1);
}
...
if ($_SESSION['klicktime'] > ($dppk_time - 15) OR empty($txt) OR !empty($_POST['priview'])) {
    ...
    $tpl = new tpl ( 'forum_v12/postedit' );
