...
if ((isset($_POST['del']) OR isset($_POST['shift']) OR isset($_POST['status'])) AND (empty($_POST['in']) OR (isset($_POST['in']) AND (!is_array($_POST['in']) OR count($_POST['in']) < 1)))) {
   ...
   FROM prefix_topics a
  	...
  	WHERE a.fid = {$fid}
   	...
   	LIMIT ".$anfang.",".$limit;
    $tpl = new tpl ('forum_v12/editforum.htm');
    $tpl->set('id', $fid);
    ...
    wd ( array (
            'neue Themen &Uuml;bersicht' => 'index.php?forum-showtopics-'.$_POST['nfid'],
            'alte Themen &Uuml;bersicht' => 'index.php?forum-showtopics-'.$_POST['afid'],
