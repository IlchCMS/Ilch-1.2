...
switch ($uum) {
    ...
    case 'showmsg':
        ...
        if ($menu->get(4) == 's') {
            $tpl = new tpl('forum_v11/pm/show_mess_send');
        } else {
            $tpl = new tpl('forum_v11/pm/show_mess');
        }
    ...
    case 'delete':
        ...
        break;
    case 'showsend':
        $tpl = new tpl('forum_v11/pm/showsend');
