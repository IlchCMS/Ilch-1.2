...
$rights = Array( 'Gast', 'User', 'Moderator', 'Administrator', 'Bot' ); 
        ...
        case 'config':
			...
			switch($strUParam) {
				...
				case 'show':
					...
					$donot = Array( 'id', 'name', 'styleDefault', 'chatBotName', 'defaultChannelID', 'requestMessagesTimeDiff', 'requestMessagesLimit', 'maxUsersLoggedIn', 'maxMessageRate');
