...
var ajaxChat = {
	...
	initDirectories: function() {
		...
		this.dirs['emoticons'] 	= this.baseURL+'include/images/ajax_chat/emoticons/';
		this.dirs['sounds']		= this.baseURL+'include/sounds/ajax_chat/';
		this.dirs['flash']		= this.baseURL+'include/includes/flash/ajax_chat/';
	},
